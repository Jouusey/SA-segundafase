...
const [biblioteca, setBiblioteca] = useState([
    ...
    return(
        <GlobalContext.Provider value={{bairro, setBairro, vetorObjetosUsuarios, setVetorObjetosUsuarios, usuarioLogado, setUsuarioLogado, posicaoUsuario, setPosicaoUsuario, biblioteca, setBiblioteca, livroAcessado, setLivroAcessado}}>
            {children}
